...
<div class="link">
~ <a href="downloads/blocks.zip" onClick="ga('send', 'event', 'Downloads', 'blocks');">zip</a>
...
<div class="link">~ <a href="http://www.cherrypy.org">link </a></div>
</div>
...
<div class="link">~ <a href="http://lpg.ticalc.org/prj_tilem/index.html">link</a></div>
</div>
...
<div class="link">~ <a href="downloads/FORMULAS.zip" onClick="ga('send', 'event', 'Downloads', 'formulas');">zip</a></div>
</div>

<div class="content">
<h2>MAROONED</h2>
<p>MAROONED is the first game I wrote. The player is stuck on a deserted island and needs to survive until a plane can be signaled. The game can be finished in about 5 minutes, but is highly dependent on luck.</p>
<div class="link">~ <a href="downloads/MAROONED.zip" onClick="ga('send', 'event', 'Downloads', 'marooned');">zip</a></div>
</div>
